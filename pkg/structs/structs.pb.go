...
type HMACRequest struct {
	...
	KeyName    string `protobuf:"bytes,1,opt,name=keyName,proto3" json:"keyName,omitempty"`
	KeyVersion string `protobuf:"bytes,2,opt,name=keyVersion,proto3" json:"keyVersion,omitempty"`
...
func (x *HMACRequest) GetKeyVersion() string {
	if x != nil {
		return x.KeyVersion
	}
	return ""
...
var file_pkg_structs_structs_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6b, 0x65, 0x79, 0x56, 0x65, 0x72,
