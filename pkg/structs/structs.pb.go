...
type UnsealResponse struct {
	...
	Unsealed  bool  `protobuf:"varint,3,opt,name=unsealed,proto3" json:"unsealed,omitempty"`
}
...
func (x *UnsealResponse) GetProcess() int32 {
	if x != nil {
		return x.Process
	}
	return 0
...
var file_pkg_structs_structs_proto_rawDesc = []byte{
	...
	,
	...
	0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x32, 0x9c, 0x02, 0x0a, 0x0a,
	...
	0x29, 0x0a, 0x06, 0x55, 0x6e, 0x73, 0x65, 0x61, 0x6c, 0x12, 0x0e, 0x2e, 0x55, 0x6e, 0x73, 0x65,
	0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x55, 0x6e, 0x73, 0x65,
	0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0d, 0x5a, 0x0b, 0x70, 0x6b,
...
var file_pkg_structs_structs_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_pkg_structs_structs_proto_goTypes = []interface{}{
	...
	(*UnsealRequest)(nil),   // 10: UnsealRequest
	(*UnsealResponse)(nil),  // 11: UnsealResponse
}
var file_pkg_structs_structs_proto_depIdxs = []int32{
	...
	10, // 11: Encryption.Unseal:input_type -> UnsealRequest
	5,  // 12: Encryption.CreateKey:output_type -> KeyResponse
	5,  // 13: Encryption.ReadKey:output_type -> KeyResponse
	5,  // 14: Encryption.DeleteKey:output_type -> KeyResponse
	6,  // 15: Encryption.ListKeys:output_type -> KeyListResponse
	9,  // 16: Encryption.Encrypt:output_type -> CryptoResult
	9,  // 17: Encryption.Decrypt:output_type -> CryptoResult
	11, // 18: Encryption.Unseal:output_type -> UnsealResponse
...
func (c *encryptionClient) Unseal(ctx context.Context, in *UnsealRequest, opts ...grpc.CallOption) (*UnsealResponse, error) {
	out := new(UnsealResponse)
	err := c.cc.Invoke(ctx, "/Encryption/Unseal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedEncryptionServer) Unseal(context.Context, *UnsealRequest) (*UnsealResponse, error) {
...
func _Encryption_Unseal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnsealRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EncryptionServer).Unseal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Encryption/Unseal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncryptionServer).Unseal(ctx, req.(*UnsealRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Encryption_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Unseal",
			Handler:    _Encryption_Unseal_Handler,
		},
	},
